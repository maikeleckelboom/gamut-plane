export interface PlaneInstrumentOffset {
  x: number;
  y: number;
}

export const PICKER_WARNING_GLYPH_SIZE = 14;
export const PICKER_WARNING_PREFERRED_OFFSET: Readonly<PlaneInstrumentOffset> = Object.freeze({
  x: 16,
  y: -16,
});
...
export const PICKER_PROJECTION_MARKER_RADIUS = 5.5;
...
export const PICKER_SLIDER_PROJECTION_COLLISION_WIDTH = 10;
