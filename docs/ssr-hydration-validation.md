...
The private React package implements the controlled OKLCH slice through `value` / `onChange`, with optional completion, cancellation and capability callbacks. The existing Canvas algorithm, generated tables and presentation geometry helpers now live in the private rendering package. Core is unchanged; the moved table file differs only in its generator-command header, and its digest remains `sha256:4c73cef992515b5876e309f7bce90cd418217c7a576f54cfcead380eb416ce15`. Vue retains its controls, lifecycle, interaction policy and visual references.
...
| `pnpm lint`                      | Passed                                                                                                                                                                                        |
| `pnpm typecheck`                 | Passed                                                                                                                                                                                        |
| `pnpm test`                      | Passed: core 48, rendering 7, Vue 67, web 14 (136 total)                                                                                                                                      |
